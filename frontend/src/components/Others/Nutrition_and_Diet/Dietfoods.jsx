...
const Dietfoods = () => {
  ...
  const renderMeal = (mealName) => {
    ...
    const totalNutrients = meal.reduce(
      (acc, food) => {
        acc.carbs += parseFloat(food.totals.carbs);
        acc.protein += parseFloat(food.totals.protein);
        acc.fats += parseFloat(food.totals.fats);
    ...
    return (
      <div className="meal">
        <h3 style={{ color: 'white', marginBottom: '20px', fontSize: '25px' }}>
        ...
        <div className="typesofmeals">
          <ul>
            {meal.map((food) => (
              <li key={food.id}>
                {food.title} - {food.quantity}g
                <button className="remove" onClick={() => removeFromMeal(mealName, food.id)}>
                  Remove
                </button>
              </li>
            ))}
  ...
  return (
    <div>
      ...
      <div className="resetbtn">
        <button onClick={resetMeals}>Reset All Meals</button>
      </div>

      <div className="total-intake-container">
        <h3 className="intake-header">Total Intake</h3>
        <div className="intake-content">
          <ul>
            <li>Total Carbs: {totalIntake.carbs.toFixed(2)} g</li>
            <li>Total Protein: {totalIntake.protein.toFixed(2)} g</li>
            <li>Total Fats: {totalIntake.fats.toFixed(2)} g</li>
            <li>Total Fiber: {totalIntake.fiber.toFixed(2)} g</li>
            <li>Total Calories: {totalIntake.calories.toFixed(2)} kcal</li>
          </ul>
          <button className="reset-button" onClick={resetTotalIntake}>
            Reset Total Intake
          </button>
        </div>
      </div>
      ...
      <div className="search-filter-container">
        <FormControl variant="outlined" className="filter-dropdown">
          ...
          <Select className="selectfood" value={filter} onChange={handleFilterChange}>
              ...
              <div key={item.id} className={`subcard ${item.isSelected ? 'selected' : ''}`}>
                <Card sx={{ width: 230 }}>
                  ...
                  <CardContent>
                    ...
                    <button className="addbtn" onClick={() => addToMeal('breakfast', item)}>
                      Add to Breakfast
                    </button>
                    <button className="addbtn" onClick={() => addToMeal('morningSnacks', item)}>
                      Add to Morning Snacks
                    </button>
                    <button className="addbtn" onClick={() => addToMeal('lunch', item)}>
                      Add to Lunch
                    </button>
                    <button className="addbtn" onClick={() => addToMeal('eveningSnacks', item)}>
                      Add to Evening Snacks
                    </button>
                    <button className="addbtn" onClick={() => addToMeal('dinner', item)}>
                      Add to Dinner
                    </button>
                  </CardContent>
                </Card>
...
//             <li key={food.id}>
//               {food.title} - {food.quantity}g
//               <button className='remove' onClick={() => removeFromMeal(mealName, food.id)}>Remove</button>
//             </li>
//           ))}
//         </ul>
//         </div>
...
//       <li>Total Calories: {totalIntake.calories.toFixed(2)} kcal</li>
//     </ul>
//     <button className="reset-button" onClick={resetTotalIntake}>Reset Total Intake</button>
//   </div>
// </div>
...
//                       onClick={() => addToMeal('breakfast', item)}
//                     >
//                       Add to Breakfast
//                     </button>
//                     <button className='add'
//                       onClick={() => addToMeal('morningSnacks', item)}
//                     >
//                       Add to Morning Snacks
//                     </button>
//                     <button className='add'
//                       onClick={() => addToMeal('lunch', item)}
//                     >
//                       Add to Lunch
//                     </button>
//                     <button className='add'
//                       onClick={() => addToMeal('eveningSnacks', item)}
//                     >
//                       Add to Evening Snacks
//                     </button>
//                     <button className='add'
//                       onClick={() => addToMeal('dinner', item)}
//                     >
//                       Add to Dinner
//                     </button>
//                   </CardContent>
